...
- **What Causes Weight Gain:** While a calorie surplus is the proximate cause of weight gain, the ultimate causes are rooted in the mismatch between our modern food environment and our biological systems, leading to hormonal imbalances and overconsumption.
...
- **Optimal Fat Loss Strategy:** Effective weight management should focus on whole, minimally processed foods, moderate calorie reduction, lowering insulin levels through reduced carb intake and intermittent fasting, and regular physical activity.
...
So why does the *"Eat less, move more"* approach to dieting has such a huge failure rate? 

Perhaps it is one of those things that is simple, but difficult. 

Or there is something else going on. 

At a fundamental level, weight gain *does* occur when you consistently consume more calories than your body expends. This is the *proximate* cause of weight gain — a sustained calorie surplus leads to the body storing excess energy as fat.

However, it's important to look beyond this simple *"calories in vs calories out"* model to understand the *ultimate* causes driving the obesity epidemic. After all, obesity rates have skyrocketed in recent decades, but it's unlikely that this is due to a sudden mass loss of willpower and self-control.

So then, we need to ask why ([in the style of Richard Feynman](https://www.youtube.com/watch?v=36GT2zI8lVA)) people are consistently consuming too many calories. 

The root cause appears to be a mismatch between our modern food environment and the biological systems that regulate our appetite, metabolism and weight.  
